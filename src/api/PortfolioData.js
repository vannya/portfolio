module.exports = {
  ...
  chingu: {
    ...
    description:
      "Front end development of the Chingu Developer Network client using React and interfacing with a Node / GraphQL / PostgreSQL backend.",
  ...
  mernapp: {
    ...
    description:
      "MERN app generator published to npm.  I found I was writing the same starter code for my projects and decided to create this to streamline my development time.  Feautures include a full Express and Node backend with keys, Google OAuth, basic routing and MongoDB database connection.  The ReactJS front end (create-react-app) includes Redux, OAuth client side routing, React Router V4 and Sass integration.",
  ...
  momentum: {
    ...
    name: "Momentum Clone",
    description:
      "Clone of a popular productivity Chrome Extension using React, Firebase and external APIs.  Features include a Pomodoro timer, daily quotes, local weather, bookmarks and agenda/checklist.  The live demo is a stand alone build of the extension for demonstration purposes.",
